...
namespace HomeSimulator.Web.Migrations
{
    ...
    [Migration("20230807232838_set init data")]
    partial class setinitdata
    {
            ...
            modelBuilder.Entity("HomeSimulator.Web.Models.Entities.Config", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AccessToken = "852a04d4197a48129ae46576e46db783",
                            ModifyTime = new DateTime(2023, 8, 8, 7, 28, 38, 633, DateTimeKind.Local).AddTicks(3652),
